...
namespace PocuterLib {
    namespace HAL {
        ...
        private:
            ...
            const char* m_webPageForm1 = "<h3 style=\"color:#FFFFFF;font-family: Verdana;font: caption;font-size: 27px;padding-top: 10px;padding-bottom: 10px;\">Please give Your WiFi Credentials</h3><FORM action=\"/\" method=\"get\"><P ><label style=\"font-family:Times New Roman\">SSID</label><br><select maxlength=\"30px\" id=\"ssid_wifi\" name=\"ssid\" style=\"width: 300px; padding: 5px 10px ; margin: 8px 0; border : 2px solid #3498db; border-radius: 4px; box-sizing:border-box\" >";
