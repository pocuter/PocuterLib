...
/* Alignments */
#define UGUI_ALIGN_H_LEFT                                  (1<<0)
#define UGUI_ALIGN_H_CENTER                                (1<<1)
#define UGUI_ALIGN_H_RIGHT                                 (1<<2)
#define UGUI_ALIGN_V_TOP                                   (1<<3)
#define UGUI_ALIGN_V_CENTER                                (1<<4)
#define UGUI_ALIGN_V_BOTTOM                                (1<<5)
#define UGUI_ALIGN_BOTTOM_RIGHT                            (UGUI_ALIGN_V_BOTTOM|UGUI_ALIGN_H_RIGHT)
#define UGUI_ALIGN_BOTTOM_CENTER                           (UGUI_ALIGN_V_BOTTOM|UGUI_ALIGN_H_CENTER)
#define UGUI_ALIGN_BOTTOM_LEFT                             (UGUI_ALIGN_V_BOTTOM|UGUI_ALIGN_H_LEFT)
#define UGUI_ALIGN_CENTER_RIGHT                            (UGUI_ALIGN_V_CENTER|UGUI_ALIGN_H_RIGHT)
#define UGUI_ALIGN_CENTER                                  (UGUI_ALIGN_V_CENTER|UGUI_ALIGN_H_CENTER)
#define UGUI_ALIGN_CENTER_LEFT                             (UGUI_ALIGN_V_CENTER|UGUI_ALIGN_H_LEFT)
#define UGUI_ALIGN_TOP_RIGHT                               (UGUI_ALIGN_V_TOP|UGUI_ALIGN_H_RIGHT)
#define UGUI_ALIGN_TOP_CENTER                              (UGUI_ALIGN_V_TOP|UGUI_ALIGN_H_CENTER)
#define UGUI_ALIGN_TOP_LEFT                                (UGUI_ALIGN_V_TOP|UGUI_ALIGN_H_LEFT)
